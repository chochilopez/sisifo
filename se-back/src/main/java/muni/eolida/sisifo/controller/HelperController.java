...
public class HelperController extends BaseController {
    ...
    public ResponseEntity<?> autoridades() {
        ...
        areaService.agregarTipoReclamoAArea((long)2,(long)1);
        areaService.agregarTipoReclamoAArea((long)2,(long)2);
        areaService.agregarTipoReclamoAArea((long)2,(long)3);
        areaService.agregarTipoReclamoAArea((long)2,(long)4);
        areaService.agregarTipoReclamoAArea((long)2,(long)5);
        areaService.agregarTipoReclamoAArea((long)10,(long)6);
        areaService.agregarTipoReclamoAArea((long)10,(long)7);
        areaService.agregarTipoReclamoAArea((long)8,(long)8);
        areaService.agregarTipoReclamoAArea((long)6,(long)9);
        areaService.agregarTipoReclamoAArea((long)6,(long)10);
        areaService.agregarTipoReclamoAArea((long)6,(long)11);
        areaService.agregarTipoReclamoAArea((long)6,(long)12);
        areaService.agregarTipoReclamoAArea((long)6,(long)13);
        areaService.agregarTipoReclamoAArea((long)2,(long)14);
        areaService.agregarTipoReclamoAArea((long)1,(long)15);
        areaService.agregarTipoReclamoAArea((long)10,(long)16);
        areaService.agregarTipoReclamoAArea((long)12,(long)17);
        areaService.agregarTipoReclamoAArea((long)8,(long)18);
        areaService.agregarTipoReclamoAArea((long)8,(long)19);
        areaService.agregarTipoReclamoAArea((long)7,(long)20);
        areaService.agregarTipoReclamoAArea((long)12,(long)21);
        areaService.agregarTipoReclamoAArea((long)8,(long)22);
        areaService.agregarTipoReclamoAArea((long)10,(long)23);
        areaService.agregarTipoReclamoAArea((long)6,(long)24);
        areaService.agregarTipoReclamoAArea((long)10,(long)25);
        areaService.agregarTipoReclamoAArea((long)10,(long)26);
        areaService.agregarTipoReclamoAArea((long)1,(long)27);
        areaService.agregarTipoReclamoAArea((long)2,(long)28);
        areaService.agregarTipoReclamoAArea((long)2,(long)29);
        areaService.agregarTipoReclamoAArea((long)11,(long)30);
        areaService.agregarTipoReclamoAArea((long)6,(long)31);
        areaService.agregarTipoReclamoAArea((long)8,(long)32);
        areaService.agregarTipoReclamoAArea((long)11,(long)33);
        areaService.agregarTipoReclamoAArea((long)12,(long)34);
        areaService.agregarTipoReclamoAArea((long)10,(long)35);
        areaService.agregarTipoReclamoAArea((long)10,(long)36);
