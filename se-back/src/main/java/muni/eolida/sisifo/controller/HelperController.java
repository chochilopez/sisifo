...
public class HelperController extends BaseController {
    ...
    public ResponseEntity<?> autoridades() {
        ...
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)1);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)2);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)3);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)4);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)5);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)6);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)7);
        tipoReclamoService.agregarTipoReclamoAArea((long)8,(long)8);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)9);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)10);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)11);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)12);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)13);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)14);
        tipoReclamoService.agregarTipoReclamoAArea((long)1,(long)15);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)16);
        tipoReclamoService.agregarTipoReclamoAArea((long)12,(long)17);
        tipoReclamoService.agregarTipoReclamoAArea((long)8,(long)18);
        tipoReclamoService.agregarTipoReclamoAArea((long)8,(long)19);
        tipoReclamoService.agregarTipoReclamoAArea((long)7,(long)20);
        tipoReclamoService.agregarTipoReclamoAArea((long)12,(long)21);
        tipoReclamoService.agregarTipoReclamoAArea((long)8,(long)22);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)23);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)24);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)25);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)26);
        tipoReclamoService.agregarTipoReclamoAArea((long)1,(long)27);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)28);
        tipoReclamoService.agregarTipoReclamoAArea((long)2,(long)29);
        tipoReclamoService.agregarTipoReclamoAArea((long)11,(long)30);
        tipoReclamoService.agregarTipoReclamoAArea((long)6,(long)31);
        tipoReclamoService.agregarTipoReclamoAArea((long)8,(long)32);
        tipoReclamoService.agregarTipoReclamoAArea((long)11,(long)33);
        tipoReclamoService.agregarTipoReclamoAArea((long)12,(long)34);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)35);
        tipoReclamoService.agregarTipoReclamoAArea((long)10,(long)36);
